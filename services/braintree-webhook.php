...
if ( ! empty( $_REQUEST['bt_challenge'] ) ) {
	echo Braintree_WebhookNotification::verify( $_REQUEST['bt_challenge'] ); } else { 		$logstr .= "Guessing you are just testing the URL out. Check that the timestamp updates on refresh to make sure this isn't being cached."; }
