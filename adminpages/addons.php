<?php
	...
	<p>
		...
		<a class="button" href="<?php echo admin_url("admin.php?page=pmpro-addons&force-check=1&plugin_status=" . $status);?>"><?php esc_html_e('Check Again', 'paid-memberships-pro' ); ?></a>
	</p>
