    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <?php
                    wp_dropdown_pages(array("name" => "cancel_page_id", "show_option_none" => "-- " . __('Choose One', 'pmpro') . " --", "selected" => $pmpro_pages['cancel'], "post_types" => $post_types ) );
                    ?>
            ...
            <tr>
                ...
                <td>
                    <?php
                    wp_dropdown_pages(array("name" => "checkout_page_id", "show_option_none" => "-- " . __('Choose One', 'pmpro') . " --", "selected" => $pmpro_pages['checkout'], "post_types" => $post_types ));
                    ?>
            ...
            <tr>
                ...
                <td>
                    <?php
                    wp_dropdown_pages(array("name" => "confirmation_page_id", "show_option_none" => "-- " . __('Choose One', 'pmpro') . " --", "selected" => $pmpro_pages['confirmation'], "post_types" => $post_types));
                    ?>
            ...
            <tr>
                ...
                <td>
                    <?php
                    wp_dropdown_pages(array("name" => "invoice_page_id", "show_option_none" => "-- " . __('Choose One', 'pmpro') . " --", "selected" => $pmpro_pages['invoice'], "post_types" => $post_types));
                    ?>
            ...
            <tr>
                ...
                <td>
                    <?php
                    wp_dropdown_pages(array("name" => "levels_page_id", "show_option_none" => "-- " . __('Choose One', 'pmpro') . " --", "selected" => $pmpro_pages['levels'], "post_types" => $post_types));
                    ?>
