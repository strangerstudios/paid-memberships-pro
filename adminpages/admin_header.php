			...
			<?php
				...
				if ( pmpro_is_paused() ) {
					...
					if ( current_user_can( 'pmpro_manage_pause_mode' ) ) { ?>
						<a class="pmpro_paused_tag" href="<?php echo esc_url( add_query_arg( array( 'page' => 'pmpro-dashboard', 'show_pause_notification' => '1' ), admin_url( 'admin.php' ) ) ); ?>"><?php esc_html_e( 'Service Disabled', 'paid-memberships-pro' ); ?></a>
					<?php } else { ?>
