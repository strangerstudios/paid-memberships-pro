...
if ( ! $notloggedintext ) {
	$notloggedintext = sprintf( __( 'Please <a href="%1$s">login</a> to view this content. (<a href="%1$s">Register here</a>.)', 'pmpro' ), wp_login_url( get_permalink() ), wp_login_url() . '?action=register' );
