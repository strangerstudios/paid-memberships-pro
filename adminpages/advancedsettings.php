...
//insert ad code here
			...
			<tr id="recaptcha_tr" <?php if(!$recaptcha) { ?>style="display: none;"<?php } ?>>
				<th scope="row" valign="top">&nbsp;</th>
				<td>
					<label for="recaptcha_sitekey"><?php _e('reCAPTCHA Site Key', 'paid-memberships-pro' );?>:</label>
					<input type="text" name="recaptcha_sitekey" size="60" value="<?php echo esc_attr($recaptcha_publickey);?>" />
					<br /><br />
					<label for="recaptcha_secretkey"><?php _e('reCAPTCHA Secret Key', 'paid-memberships-pro' );?>:</label>
					<input type="text" name="recaptcha_secretkey" size="60" value="<?php echo esc_attr($recaptcha_privatekey);?>" />
				</td>
			</tr>
			<tr>
				<th scope="row" valign="top">
