	...
	<div class="actions">							
		<form method="post" name="component-actions" action="">
			...
			<?php } elseif(file_exists(dirname(__FILE__) . "/../../../hide-admin-bar-from-non-admins/hide-admin-bar-from-non-admins.php")) { ?>
				<a href="<?php echo wp_nonce_url(self_admin_url('plugins.php?action=activate&plugin=hide-admin-bar-from-non-admins/hide-admin-bar-from-non-admins.php'), 'activate-plugin_pmpro-register-helper/hide-admin-bar-from-non-admins.php')?>" class="button button-primary">Activate</a>
			<?php } else { ?>
