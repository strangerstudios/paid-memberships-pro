...
?>
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<tbody>
			...
			<?php $cardinal_gateways = array('cybersource','stripe', 'authorizenet', 'paypal', 'paypalexpress', 'paypalstandard', 'payflowpro', 'braintree'); ?>

			<tr class="pmpro_settings_divider gateway gateway_stripe gateway_cybersource gateway_authorizenet gateway_paypal gateway_paypalexpress gateway_paypalstandard gateway_payflowpro gateway_braintree" <?php if(!in_array( $gateway, $cardinal_gateways )) { ?>style="display: none;"<?php } ?>>
				<td colspan="2">
					<?php _e('CardinalCommerce Settings', 'paid-memberships-pro' ); ?>
				</td>
			</tr>
			<tr class="gateway gateway_stripe gateway_cybersource gateway_authorizenet gateway_paypal gateway_paypalexpress gateway_paypalstandard gateway_payflowpro gateway_braintree" <?php if(!in_array( $gateway, $cardinal_gateways )) { ?>style="display: none;"<?php } ?>>
				<th scope="row" valign="top">
