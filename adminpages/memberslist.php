...
$members_export_filters = pmpro_sanitize_memberships_list_filters( $_REQUEST );
if ( isset( $_REQUEST['s'] ) ) {
...
?>
	...
	<form id="member-list-form" method="get">		
		<h1 class="wp-heading-inline"><?php esc_html_e( 'Memberships', 'paid-memberships-pro' ); ?></h1>
		...
		?>
		<div id="pmpro-memberships-layout" class="pmpro-filter-layout">
