			...
			<div class="welcome-panel-column-container">
				...
				<div class="welcome-panel-column">
					...
					<?php if(!pmpro_license_isValid() && empty($key)) { ?>
						<p class="pmpro_message pmpro_error"><?php printf(__( 'No support license key found. <a href="%s">Enter your support license key here &raquo;</a>', 'paid-memberships-pro' ), admin_url( 'options-general.php?page=pmpro_license_settings' ) );?></p>
					<?php } elseif(!pmpro_license_isValid()) { ?>
						<p class="pmpro_message pmpro_warning"><?php _e( 'Your license is invalid or expired.', 'paid-memberships-pro' );?></strong> <?php _e( 'Visit the PMPro <a href="https://www.paidmembershipspro.com/login/?redirect_to=/membership-account/?utm_source=plugin&utm_medium=banner&utm_campaign=license_notice" target="_blank">Membership Account</a> page to confirm that your account is active and to find your license key.', 'paid-memberships-pro' );?></p>
					<?php } else { ?>
					...
					<?php } ?>
					<p><?php echo esc_html( 'An annual support license is recommended for websites running Paid Memberships Pro.', 'paid-memberships-pro' ); ?> <a href="http://www.paidmembershipspro.com/pricing/?utm_source=plugin&utm_medium=banner&utm_campaign=license_notice" target="_blank">View Pricing &raquo;</a></p>
