...
* FEATURE: Added support for setting custom inclusive tax rates by location. This feature is currently in beta and can be enabled from the Memberships > Settings > Payments settings page. #3329 (@dparker1005)
...
* ENHANCEMENT: Added a new `pmpro_no_download` parameter to CSV exports to prevent downloading the CSV file. #3417 (@dalemugford)
