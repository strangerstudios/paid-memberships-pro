...
<p>Log in to your WordPress admin here: !!login_url!!</p>', 'paid-memberships-pro' ) );
	...
	public static function send_test( $email ) {
		...
		$test_checkout_free_template = new PMPro_Email_Template_Checkout_Free_Admin( $current_user, $test_order );
		...
		$test_email->data = array_merge( $test_checkout_free_template->get_base_email_template_variables(),
			$test_checkout_free_template->get_email_template_variables() );
