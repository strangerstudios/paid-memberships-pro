	...
	class PMProGateway_Twocheckout extends PMProGateway
	{
		...
		static function pmpro_checkout_default_submit_button($show)
		{
			...
			<span id="pmpro_submit_span">
				...
				<input type="submit" class="<?php echo pmpro_get_element_class( array( 'pmpro_btn', 'pmpro_btn-submit-checkout' ), 'pmpro_btn-submit-checkout' ); ?>" value="<?php if($pmpro_requirebilling) { _e('Check Out with 2Checkout', 'paid-memberships-pro' ); } else { _e('Submit and Confirm', 'paid-memberships-pro' );}?> &raquo;" />
			</span>
			<?php
