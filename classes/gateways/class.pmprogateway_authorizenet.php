	...
	class PMProGateway_authorizenet extends PMProGateway
	{
		...
		static function getGatewayOptions()
		{
			$options = array(
				...
				'authorizenet_cardinal_apikey',
				'authorizenet_cardinal_apiidentifier',
				'authorizenet_cardinal_orgunitid',
				'authorizenet_cardinal_songbirdurl',
				'authorizenet_cardinal_merchantid',
				'authorizenet_cardinal_processorid'
			);
		...
		<tr class="gateway gateway_authorizenet" <?php if($gateway != "authorizenet") { ?>style="display: none;"<?php } ?>>
			<th scope="row" valign="top">
				<label for="authorizenet_cardinal_apikey"><?php _e('API Key', 'paid-memberships-pro' );?>:</label>
			</th>
			<td>
				<input type="text" id="authorizenet_cardinal_apikey" name="authorizenet_cardinal_apikey" size="60" value="<?php echo esc_attr($values['authorizenet_cardinal_apikey'])?>" />
			</td>
		</tr>
		<tr class="gateway gateway_authorizenet" <?php if($gateway != "authorizenet") { ?>style="display: none;"<?php } ?>>
			<th scope="row" valign="top">
				<label for="authorizenet_cardinal_apiidentifier"><?php _e('API Identifier', 'paid-memberships-pro' );?>:</label>
			</th>
			<td>
				<input type="text" id="authorizenet_cardinal_apiidentifier" name="authorizenet_cardinal_apiidentifier" size="60" value="<?php echo esc_attr($values['authorizenet_cardinal_apiidentifier'])?>" />
			</td>
		</tr>
		<tr class="gateway gateway_authorizenet" <?php if($gateway != "authorizenet") { ?>style="display: none;"<?php } ?>>
			<th scope="row" valign="top">
				<label for="authorizenet_cardinal_orgunitid"><?php _e('Org Unit ID', 'paid-memberships-pro' );?>:</label>
			</th>
			<td>
				<input type="text" id="authorizenet_cardinal_orgunitid" name="authorizenet_cardinal_orgunitid" size="60" value="<?php echo esc_attr($values['authorizenet_cardinal_orgunitid'])?>" />
			</td>
		</tr>
		<tr class="gateway gateway_authorizenet" <?php if($gateway != "authorizenet") { ?>style="display: none;"<?php } ?>>
			<th scope="row" valign="top">
				<label for="authorizenet_cardinal_songbirdurl"><?php _e('Songbird URL', 'paid-memberships-pro' );?>:</label>
			</th>
			<td>
				<input type="text" id="authorizenet_cardinal_songbirdurl" name="authorizenet_cardinal_songbirdurl" size="60" value="<?php echo esc_attr($values['authorizenet_cardinal_songbirdurl'])?>" />
			</td>
		</tr>
		<tr class="gateway gateway_authorizenet" <?php if($gateway != "authorizenet") { ?>style="display: none;"<?php } ?>>
			<th scope="row" valign="top">
				<label for="authorizenet_cardinal_merchantid"><?php _e('Merchant ID', 'paid-memberships-pro' );?>:</label>
			</th>
			<td>
				<input type="text" id="authorizenet_cardinal_merchantid" name="authorizenet_cardinal_merchantid" size="60" value="<?php echo esc_attr($values['authorizenet_cardinal_merchantid'])?>" />
			</td>
		</tr>
		<tr class="gateway gateway_authorizenet" <?php if($gateway != "authorizenet") { ?>style="display: none;"<?php } ?>>
			<th scope="row" valign="top">
				<label for="authorizenet_cardinal_processorid"><?php _e('Processor ID', 'paid-memberships-pro' );?>:</label>
			</th>
			<td>
				<input type="text" id="authorizenet_cardinal_processorid" name="authorizenet_cardinal_processorid" size="60" value="<?php echo esc_attr($values['authorizenet_cardinal_processorid'])?>" />
			</td>
		</tr>
		<?php
		}
