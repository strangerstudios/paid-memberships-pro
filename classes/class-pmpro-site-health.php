...
class PMPro_Site_Health {
	...
	/**
	 * Show warning in Site Health Status for incorrect Add On folder names.
	 *
	 * @since TBD
	 */
	...
	/**
	 * Helper function to check for any incorrect Add On folder names and return a warning if found.
	 * 
	 * @since TBD
	 */
