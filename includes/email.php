...
function pmpro_send_html( $phpmailer ) {
	...
	if ( file_exists( get_stylesheet_directory() . '/email_header.html' ) ) {
		$header = file_get_contents( get_stylesheet_directory() . '/email_header.html' ); } elseif ( file_exists( get_template_directory() . '/email_header.html' ) ) {
		$header = file_get_contents( get_template_directory() . '/email_header.html' ); } else { 		$header = ''; }

		// Get footer for message if found
		if ( file_exists( get_stylesheet_directory() . '/email_footer.html' ) ) {
			$footer = file_get_contents( get_stylesheet_directory() . '/email_footer.html' ); } elseif ( file_exists( get_template_directory() . '/email_footer.html' ) ) {
			$footer = file_get_contents( get_template_directory() . '/email_footer.html' ); } else { 		$footer = ''; }
