...
function pmpro_upgrade_1() {
	...
	*/
	...
	$notloggedintext = sprintf( __( 'This content is for !!levels!! members only.<br /><a href="%1$s">Log In</a> <a href="%1$s">Register</a>', 'pmpro' ), wp_login_url(), wp_login_url() . '?action=register' );
