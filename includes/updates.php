...
<div class="update-nag">
	...
	<?php
		...
		echo sprintf( __( '(1) <a target="_blank" href="%1$s">Backup your WordPress database</a></strong> and then (2) <a href="%1$s">click here to start the update</a>.', 'pmpro' ), 'https://codex.wordpress.org/WordPress_Backups#Database_Backup_Instructions', admin_url( 'admin.php?page=pmpro-updates' ) );
	?>
	</p>
</div>
<?php
