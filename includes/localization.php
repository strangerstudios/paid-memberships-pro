...
function pmpro_translate_billing_period( $period, $number = 1 ) {
	...
	if ( $number == 1 ) {
		if ( $period == 'Day' ) {
			return __( 'Day', 'pmpro' ); } elseif ( $period == 'Week' ) {
			return __( 'Week', 'pmpro' ); } elseif ( $period == 'Month' ) {
				return __( 'Month', 'pmpro' ); } elseif ( $period == 'Year' ) {
				return __( 'Year', 'pmpro' ); }
	} else {
		if ( $period == 'Day' ) {
			return __( 'Days', 'pmpro' ); } elseif ( $period == 'Week' ) {
			return __( 'Weeks', 'pmpro' ); } elseif ( $period == 'Month' ) {
				return __( 'Months', 'pmpro' ); } elseif ( $period == 'Year' ) {
