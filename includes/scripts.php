...
function pmpro_admin_enqueue_scripts() {
	...
	if (
		'toplevel_page_pmpro-dashboard' === $current_screen ||
		'memberships_page_pmpro-memberslist' === $current_screen ||
		'memberships_page_pmpro-orders' === $current_screen ||
		'memberships_page_pmpro-reports' === $current_screen ||
		'memberships_page_pmpro-membershiplevels' === $current_screen ||
		'memberships_page_pmpro-addons' === $current_screen ||
		'memberships_page_pmpro-license' === $current_screen
	) {

		// Admin JS.
		wp_register_script(
			'pmpro_admin',
			plugins_url( 'js/pmpro-admin.js', __DIR__ ),
			array(
				'jquery',
				'jquery-ui-sortable',
			),
