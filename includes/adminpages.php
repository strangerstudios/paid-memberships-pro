...
function pmpro_add_pages()
{
	...
	add_submenu_page( 'pmpro-membershiplevels', __( 'Welcome Guide', 'paid-memberships-pro' ), __( 'Welcome Guide', 'paid-memberships-pro' ), 'pmpro_welcome', 'pmpro-welcome', 'pmpro_welcome' );
