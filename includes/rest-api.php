...
if ( class_exists( 'WP_REST_Controller' ) ) {
	class PMPro_REST_API_Routes extends WP_REST_Controller {
		...
		function pmpro_rest_api_set_membership_level( $request ) {
			...
			$cycle_period = isset( $params['cycle_period'] ) ? pmpro_sanitize_with_safelist( sanitize_text_field( $params['cycle_period'] ), pmpro_get_allowed_cycle_periods() ) : $level->cycle_period;
