...
<div id="pmpro_message" class="pmpro_message" style="display: none;"></div>
	...
	<?php } elseif ( $current_user->ID && ! $pmpro_review ) { ?>
		...
		<p id="pmpro_account_loggedin">
			<?php printf( __( 'You are logged in as <strong>%1$s</strong>. If you would like to use a different account for this membership, <a href="%1$s">log out now</a>.', 'pmpro' ), $current_user->user_login, wp_logout_url( $_SERVER['REQUEST_URI'] ) ); ?>
		</p>
	<?php } ?>
