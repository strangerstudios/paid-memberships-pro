...
<p>
	<a class="pmpro_yeslink yeslink" href="<?php echo pmpro_url("cancel", "?confirm=true")?>">Yes, cancel my account</a>
	|
	<a class="pmpro_nolink nolink" href="<?php echo pmpro_url("account")?>">No, keep my account</a>
</p>
<?php } else { ?>
