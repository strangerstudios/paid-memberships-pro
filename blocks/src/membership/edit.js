	...
	return [
	  isSelected && (
		<InspectorControls>
		  <PanelBody>
			<p>
			  <strong>{__('Which membership levels can view this block?', 'paid-memberships-pro')}</strong>
			</p>
			<div className="pmpro-block-inspector-scrollable">{checkboxes}</div>
			<p>
			<Button
			...
			<p>
			  <strong>{__('What should users without access see?', 'paid-memberships-pro')}</strong>
			</p>
			<SelectControl
			  value={show_noaccess}
