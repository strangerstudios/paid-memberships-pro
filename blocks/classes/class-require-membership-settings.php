<?php 
class PMPro_blocks_helper_class {
	...
	* @since TBD
	*/
	public static function filter_block_content( $attributes, $content ) {
		$output = '';
		//Bail if segment isn't set.
		if( ! isset( $attributes['segment'] ) || ! isset( $attributes['invert_restrictions'] ) ) {
