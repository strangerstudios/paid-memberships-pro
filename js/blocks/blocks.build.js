...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (registerBlockType('pmpro/single-level-description', {
  ...
  edit: props => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", useBlockProps(), getDescription(props.attributes.selected_level));
  },
  save(props) {
...
const getExpirationText = level => {
  return pmpro.all_levels_formatted_text[level] ? pmpro.all_levels_formatted_text[level].formatted_expiration : 'Expiration placeholder';
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (registerBlockType('pmpro/single-level-expiration', {
  ...
  edit: props => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", useBlockProps(), getExpirationText(props.attributes.selected_level));
  },
  save(props) {
    const blockProps = useBlockProps.save();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (registerBlockType('pmpro/single-level-name', {
  ...
  edit: props => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", useBlockProps(), getName(props.attributes.selected_level));
  },
  save: props => {
    const blockProps = useBlockProps.save();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (registerBlockType('pmpro/single-level-price', {
  ...
  edit: props => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", useBlockProps(), getFormattedPrice(props.attributes.selected_level));
  },
  save: props => {
    const blockProps = useBlockProps.save();
